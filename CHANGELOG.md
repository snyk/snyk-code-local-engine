...
- Fixed `service-health-aggregator` crash on startup (`__dirname is not defined in ES module scope`) caused by a CommonJS reference in the ESM bundle. Added a bundle smoke test to CI to prevent similar regressions.
